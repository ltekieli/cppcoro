...
namespace cppcoro
{
	...
	namespace detail
	{
		...
		public:
			...
			constexpr coroutine_ns::suspend_always initial_suspend() const noexcept { return {}; }
			constexpr coroutine_ns::suspend_always final_suspend() const noexcept { return {}; }

			template<
				typename U = T,
				std::enable_if_t<!std::is_rvalue_reference<U>::value, int> = 0>
			coroutine_ns::suspend_always yield_value(std::remove_reference_t<T>& value) noexcept
			{
		...
		{
			using coroutine_handle = coroutine_ns::coroutine_handle<generator_promise<T>>;
	...
	private:
		...
		explicit generator(coroutine_ns::coroutine_handle<promise_type> coroutine) noexcept
			: m_coroutine(coroutine)
		{}
