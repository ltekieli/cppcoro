...
namespace cppcoro
{
	...
	namespace detail
	{
		...
		public:
			...
			coroutine_ns::suspend_always initial_suspend() const noexcept
			{
				return {};
			}
		...
		private:
			...
			coroutine_ns::coroutine_handle<> m_consumerCoroutine;
		...
		public:
			...
			async_generator_yield_operation(coroutine_ns::coroutine_handle<> consumer) noexcept
				: m_consumer(consumer)
			{}
			...
			coroutine_ns::coroutine_handle<>
			await_suspend([[maybe_unused]] coroutine_ns::coroutine_handle<> producer) noexcept
			{
				return m_consumer;
			}
		...
		private:
			...
			coroutine_ns::coroutine_handle<> m_consumer;
		...
		protected:
			...
			async_generator_advance_operation(
				...
				coroutine_ns::coroutine_handle<> producerCoroutine) noexcept
		...
		public:
			...
			coroutine_ns::coroutine_handle<>
				await_suspend(coroutine_ns::coroutine_handle<> consumerCoroutine) noexcept
			{
		...
		protected:
			...
			coroutine_ns::coroutine_handle<> m_producerCoroutine;
	...
	public:
		...
		explicit async_generator(promise_type& promise) noexcept
			: m_coroutine(coroutine_ns::coroutine_handle<promise_type>::from_promise(promise))
		{}
	...
	private:
		...
		coroutine_ns::coroutine_handle<promise_type> m_coroutine;
	...
	namespace detail
	{
		...
		public:
			...
			bool await_suspend(coroutine_ns::coroutine_handle<> producer) noexcept;
		...
		inline bool async_generator_yield_operation::await_suspend(
			coroutine_ns::coroutine_handle<> producer) noexcept
		{
		...
		public:
			...
			bool await_suspend(coroutine_ns::coroutine_handle<> consumerCoroutine) noexcept
			{
				m_promise->m_consumerCoroutine = consumerCoroutine;
