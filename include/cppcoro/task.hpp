...
namespace cppcoro
{
	...
	namespace detail
	{
		class task_promise_base
		{
			...
			struct final_awaitable
			{
				...
				coroutine_ns::coroutine_handle<> await_suspend(
					coroutine_ns::coroutine_handle<PROMISE> coro) noexcept
				{
				...
				template<typename PROMISE>
				CPPCORO_NOINLINE
				void await_suspend(coroutine_ns::coroutine_handle<PROMISE> coroutine)
				{
		...
		public:
			...
			{
				return coroutine_ns::suspend_always{};
			}
...
#else
			bool try_set_continuation(coroutine_ns::coroutine_handle<> continuation)
			{
				m_continuation = continuation;
		...
		private:
			...
			coroutine_ns::coroutine_handle<> m_continuation;
	...
	private:
		...
		struct awaitable_base
		{
			...
			awaitable_base(coroutine_ns::coroutine_handle<promise_type> coroutine) noexcept
...
#if CPPCORO_COMPILER_SUPPORTS_SYMMETRIC_TRANSFER
			coroutine_ns::coroutine_handle<> await_suspend(
				coroutine_ns::coroutine_handle<> awaitingCoroutine) noexcept
			{
				m_coroutine.promise().set_continuation(awaitingCoroutine);
				return m_coroutine;
			}
#else
			bool await_suspend(coroutine_ns::coroutine_handle<> awaitingCoroutine) noexcept
			{
	...
	public:
		...
		explicit task(coroutine_ns::coroutine_handle<promise_type> coroutine)
			: m_coroutine(coroutine)
		{}
	...
	namespace detail
	{
		...
		{
			return task<T>{ coroutine_ns::coroutine_handle<task_promise>::from_promise(*this) };
		}

		inline task<void> task_promise<void>::get_return_object() noexcept
		{
			return task<void>{ coroutine_ns::coroutine_handle<task_promise>::from_promise(*this) };
		}
