...
namespace cppcoro
{
	...
	namespace detail
	{
		...
		class shared_task_promise_base
		{
			...
			struct final_awaiter
			{
				...
				void await_suspend(coroutine_ns::coroutine_handle<PROMISE> h) noexcept
				{
		...
		public:
			...
			bool try_await(shared_task_waiter* waiter, coroutine_ns::coroutine_handle<> coroutine)
			{
	...
	private:
		...
		struct awaitable_base
		{
			...
			bool await_suspend(coroutine_ns::coroutine_handle<> awaiter) noexcept
			{
	...
	public:
		...
		explicit shared_task(coroutine_ns::coroutine_handle<promise_type> coroutine)
			: m_coroutine(coroutine)
		{
	...
	namespace detail
	{
		...
		shared_task<T> shared_task_promise<T>::get_return_object() noexcept
		{
			return shared_task<T>{
				coroutine_ns::coroutine_handle<shared_task_promise>::from_promise(*this)
			};
		}
