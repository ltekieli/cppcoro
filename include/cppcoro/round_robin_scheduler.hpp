...
namespace cppcoro
{
	...
	public:
		round_robin_scheduler() noexcept
			: m_index(0)
			, m_noop(coroutine_ns::noop_coroutine())
		{
	...
	private:
		...
		coroutine_ns::coroutine_handle exchange_next(
			coroutine_ns::coroutine_handle<> coroutine) noexcept
		{
		...
		size_t m_index;
		const coroutine_ns::coroutine_handle<> m_noop;
		std::array<coroutine_ns::coroutine_handle<>, N - 1> m_coroutines;
	};
#endif
}
