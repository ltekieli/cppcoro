...
namespace cppcoro
{
	...
	public:
		...
		[[nodiscard]] auto join() noexcept
		{
			...
			public:
				...
				bool await_suspend(coroutine_ns::coroutine_handle<> continuation) noexcept
				{
	...
	private:
		...
		struct oneway_task
		{
			struct promise_type
			{
				coroutine_ns::suspend_never initial_suspend() { return {}; }
				coroutine_ns::suspend_never final_suspend() { return {}; }
