...
namespace cppcoro
{
	...
	public:
		...
		public:
			...
			coroutine_ns::suspend_always initial_suspend() noexcept
			{
				return {};
			}

			coroutine_ns::suspend_always final_suspend() noexcept
			{
				return {};
			}
			...
			coroutine_ns::suspend_always yield_value(T& value) noexcept
			{
			...
			auto yield_value(recursive_generator& generator) noexcept
			{
				struct awaitable
				{
					...
					void await_suspend(coroutine_ns::coroutine_handle<promise_type>) noexcept
					{}
			...
			template<typename U>
			coroutine_ns::suspend_never await_transform(U&& value) = delete;

			void destroy() noexcept
			{
				coroutine_ns::coroutine_handle<promise_type>::from_promise(*this).destroy();
			}
			...
			{
				return coroutine_ns::coroutine_handle<promise_type>::from_promise(*this).done();
			}
		...
		private:
			...
			{
				coroutine_ns::coroutine_handle<promise_type>::from_promise(*this).resume();
			}
