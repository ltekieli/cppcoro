...
namespace cppcoro
{
	...
	public:
		...
		void await_suspend(coroutine_ns::coroutine_handle<> awaiter) noexcept;
	...
	private:
		...
		coroutine_ns::coroutine_handle<> m_awaiter;
	...
	public:
		...
		void await_suspend(coroutine_ns::coroutine_handle<> awaiter);
		void await_resume();
